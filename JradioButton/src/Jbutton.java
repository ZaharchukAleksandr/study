...
//JRadioButton button5 = new JRadioButton ("кнопка 5");
//JRadioButton button6 = new JRadioButton ("кнопка 6");
//JRadioButton button7 = new JRadioButton ("кнопка 7");
//JRadioButton button8 = new JRadioButton ("кнопка 8");
//JRadioButton button9 = new JRadioButton ("кнопка 9");
//JRadioButton button10 = new JRadioButton ("кнопка 10");
//JRadioButton button11 = new JRadioButton ("кнопка 11");
