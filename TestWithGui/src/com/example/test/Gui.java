...
public class Gui extends JFrame {
	...
	private JTextArea area =  new JTextArea("Необходимо вывести на экран числа от 1 до 5.На экране должно быть:  1 2 3 4 5 ");
	...
	public Gui() {
		...
		//Создаем главный контейнер в который будем класть все остальные панели
		Container container = this.getContentPane();
		container.setLayout(new GridLayout(3,1,5,0));
		
		//Создаем панель в которую кладем текстовые панели
		...
		//Создаем панель для кнопок free и Clear
		...
		// Создаем панель для кнопок Start and Exit
