...
public class Benzin extends Car{
	...
	@Override
	void exciseTax() {
		// если обьем двигателя меньше 2х литров
		...
		// если обьем двигатель больше 2х литров
		}
		else { 
	...
	// расчет ввозной пошлины 
	@Override
	void dutyTax() {
		CustomsCalculator.castomsTax = (getCarPrice() * CustomsCalculator.tax) / 100;
